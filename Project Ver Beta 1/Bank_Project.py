            ...
            if bf.checkName(i, cname):
                if bf.confirmer():
                    ...
                    if transfer in ("y", "1", "yes"):
                        recipient = str(input("Who would you wish to transfer funds to?\n>>> "))
                        ask = str(
                        ...
                        if ask in ("y", "1", "yes"):
                            ...
                            bf.transferlocal(recipient, customerdata, customers, cname, current)
